...
export default function VideoCard (props) {
    ...
    return (
        <div className="pt-3 pb-6 cursor-pointer card">
            <img src={props.img} alt="sydney" className="w-full rounded-xl transition-all hover:rounded-none h-80"/>

            <div className="wrapper flex items-center">
                <img src={channelPic}  className="w-12 h-12 rounded-full relative top-1"/>
                <div>
